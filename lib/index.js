...
schemas.register_options = Joi.object({
    ...
    responseMessage: Joi.object({
        onDeny: Joi.string().optional(),
        onUndetermined: Joi.string().optional(),
    }).optional(),
...
defaults.options = {
    ...
    responseMessage: {
        onDeny: "No permissions to access this resource",
        onUndetermined: "Could not evaluate access rights to resource",
    },
    dataRetrievers: []
};
        ...
        if (config && config !== CONFIG_NONE) {
            try {
                ...
                if (result === RbacCore.DENY) {
                    return options.onError(request, h, new Boom(options.responseMessage.onDeny, {
                        statusCode: options.responseCode.onDeny
                    }));
                }

                if (result === RbacCore.UNDETERMINED) {
                    return options.onError(request, h, new Boom(options.responseMessage.onUndetermined, {
